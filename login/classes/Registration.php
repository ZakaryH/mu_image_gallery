...
class Registration
{
    ...
    private function registerNewUser()
    {
        ...
        } elseif ($_FILES['image_file']['size'] > 1000000) {
            $this->errors[] = "File is too large";
        } elseif ($imageFileType != 'jpg' && $imageFileType != 'png' && $imageFileType != 'jpeg' && $imageFileType != 'gif') {
            $this->errors[] = "Must be a jpg, jpeg, png or gif file.";
        }
            ...
            if (!$this->db_connection->connect_errno) {
                ...
                if ($query_check_user_name->num_rows == 1) {
                    ...
                    if (move_uploaded_file($_FILES['image_file']['tmp_name'], $target_file)) {
                        ...
                        $sql = "INSERT INTO users (user_name, user_password_hash, user_email, user_avatar)
                                VALUES('" . $user_name . "', '" . $user_password_hash . "', '" . $user_email . "', '" . $upload_file . "');";
